...
PACKAGES="$PACKAGES oonf-dlep-proxy"
PACKAGES="$PACKAGES oonf-dlep-radio"
PACKAGES="$PACKAGES oonf-init-scripts"
PACKAGES="$PACKAGES oonf-olsrd2"
PACKAGES="$PACKAGES opennds"
PACKAGES="$PACKAGES pimbd"
PACKAGES="$PACKAGES prince"
PACKAGES="$PACKAGES quagga"
